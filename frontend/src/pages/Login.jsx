...
import { FaGoogle, FaFacebook, FaTwitter, FaEye, FaEyeSlash, FaLock, FaEnvelope } from 'react-icons/fa';
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-8">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center">
              <span className="px-4 bg-white text-sm text-gray-500">Hoặc đăng nhập bằng email</span>
            </div>
          </div>
